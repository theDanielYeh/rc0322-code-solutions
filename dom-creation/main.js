...
function renderPokemon(pokemon) {
  ...
  var theContainer = document.querySelector('div.container');
  theContainer.appendChild(outerDiv);
  ...
  newImg.setAttribute('src', 'images/' + pokemon.name.toLowerCase() + '.png');
...
for (var i = 0; i < pokedex.length; i++) {
  var $rendering = renderPokemon(pokedex[i]);
  $row.appendChild($rendering);
}
